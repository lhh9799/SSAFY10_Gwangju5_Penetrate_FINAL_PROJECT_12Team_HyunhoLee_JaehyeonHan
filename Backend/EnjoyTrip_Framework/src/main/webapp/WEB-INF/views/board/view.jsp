       ...
       <div class="col-lg-8 col-md-10 col-sm-12">
		...
		<div class="row">
				...
				<div class="clearfix align-content-center">
					<img class="avatar me-2 float-md-start bg-light p-2" src="https://raw.githubusercontent.com/twbs/icons/main/icons/person-fill.svg"/>
               		<p>
						...
						<span class="text-secondary fw-light"> ${article.registerTime} 조회 : ${article.hit} 추천수 : ${article.recommend}</span>
					</p>
             		</div>
           	</div>
			...
			<div class="d-flex justify-content-end">
				<button type="button" id="btn-recommend" class="btn btn-outline-primary mb-3">추천하기</button>
				<button type="button" id="btn-list" class="btn btn-outline-primary mb-3">글목록</button>
				<c:if test="${userDto.userId eq article.userId}">
...
<script>
	...
	document.querySelector("#btn-recommend").addEventListener("click", function () {
		location.href = "${root}/board/recommend?articleno=${article.articleNo}";
	});
